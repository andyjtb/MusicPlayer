...
public:
    ...
    //NON DROW
    /** This can be used to load a previously saved Playlists tree.
     This has to be in the same format as that generated by this class.
     If the tree passed in is invalid, it will create a new, valid one.
     */
    void setPlaylistsTree (ValueTree& newTreeToUse);
    ...
    //NON DROW
    /** Returns the Playlists ValueTree */
    ValueTree getPlaylistsTree() { return playlistsTree;}
...
private:
	...
	ValueTree libraryTree, playlistsTree;
